...
docker run -it --rm -v $(pwd)/Examples/Stereo-Inertial/FoMo/winter:/dataset -v $(pwd)/output:/output -e DATASET_PATH=/dataset -e OUTPUT_PATH=/output orbslam3offline:latest run_orbslam3
```
